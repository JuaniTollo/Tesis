...
\usepackage{graphicx}
\usepackage{mdframed} % Necesitas incluir este paquete
\usepackage{natbib}  % Usa natbib para manejar la bibliografía
\usepackage{grffile} % Permite nombres de archivos con caracteres especiales
\usepackage{amsmath}
\usepackage{subcaption}  % Asegúrate de cargar subcaption para el manejo de subfiguras
